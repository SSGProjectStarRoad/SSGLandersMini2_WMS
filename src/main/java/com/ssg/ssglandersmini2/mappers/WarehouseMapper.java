...
public interface WarehouseMapper {
    ...
    List<Warehouse> getAllWarehouse(); //창고의 전체목록을 불러오는 메서드
    Warehouse getOneWarehouse(long wid); //id에 해당하는 하나의 창고를 불러오는 메서드
//    void updateWarehouse(Warehouse warehouse); //창고를 수정하는 메서드
    void deleteWarehouse(long wid); //id에 해당하는 창고를 삭제하는 메서드
