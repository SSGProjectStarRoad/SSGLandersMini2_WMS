...
public class UserController {
    ...
    @PostMapping("/update")
    @ResponseBody
    public String update(@Valid @RequestBody UserUpdateDTO userUpdateDTO, BindingResult bindingResult, RedirectAttributes redirectAttributes) {
        ...
        if (bindingResult.hasErrors()) {
            ...
            return "redirect:/ssglanders/userlist?error=validation";
        }
        try {
            // 사용자 정보 업데이트를 시도
            ...
            // 수정 완료 후 목록 페이지로 이동
            return "redirect:/ssglanders/list";
