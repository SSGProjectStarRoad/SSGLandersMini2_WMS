$(document).ready(function () {
    ...
    $(document).on('click', '.btn-update-real', function () {
        ...
        let zipp_code = $('#zipp_code').val();
        let UserAdd1 = $('#UserAdd1').val();
        let UserAdd2 = $('#UserAdd2').val();

        let address = UserAdd1 + UserAdd2;

        console.log('사용자 정보: '+ address);
        ...
        $.ajax({
            url: '/ssglanders/update', // 서버의 URL. 필요에 따라 수정하세요.
            type: 'POST',
